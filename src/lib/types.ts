...
export type StylePackId = "whiteboard" | "ink-wash" | "minhwa" | "doodle-edu" | "joseon-reaper" | "flat-icon" | "retro-poster" | "dark-neon" | "3d-iso" | "newspaper-cartoon" | "comic-essay" | "collage" | "drone-light" | "graphic-novel" | "cinematic-hype" | "euro-graphic-novel" | "pop-art" | "webtoon" | "explainer-doodle" | "mono-line";
...
export interface SceneSpec {
  ...
  hand?: { enabled: boolean; asset: string; size?: number; count?: number; speed?: number; brushType?: BrushType; inkSpread?: number; fillRange?: number; blurLevel?: 1 | 2 | 3 };
