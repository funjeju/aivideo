...
export const STYLE_PACKS: Record<string, StylePackDoc> = {
  ...
  "explainer-doodle": {
    ...
    imagePrompt: {
      template:
        "hand-drawn marker SKETCHNOTE illustration in the style of live whiteboard scribing / RSA Animate / Golpo explainer videos, {subject}. EVERYTHING looks genuinely drawn by hand with a felt-tip marker on paper: bold confident but slightly WOBBLY imperfect black outlines (NOT smooth vector lines), loose energetic hand-drawn linework, visible marker texture. Hand-lettered text (looks written by hand, not a typed font), simple cartoon characters and icons, hand-drawn arrows and rounded callout/speech boxes, a few key words emphasized with rough highlighter strokes (yellow, red). Colors filled loosely with marker leaving slight uneven texture, light cream paper background, generous whitespace, casual energetic friendly feel. Only short keyword labels (no sentences, no paragraphs).",
      negative: "flat vector art, clean digital illustration, smooth precise outlines, corporate flat design, perfectly even color fills, vector infographic, gradient, 3d render, photorealistic, typed printed font text, sterile, polished CGI, watercolor, ink wash, dark background, dense paragraphs, walls of text, manga, anime",
      model: "gpt-image-2",
      quality: "medium",
      size: "1024x1536",
    },
